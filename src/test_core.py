...
def test_content_rule_fail_with_no_match() -> None:
    rule = ContentRule("body-test-rule")
...
# HEALTHY -> all pass
def test_report_is_healthy_when_all_pass(endpoint: Endpoint) -> None:
